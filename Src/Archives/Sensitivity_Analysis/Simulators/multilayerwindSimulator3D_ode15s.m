    ...
    methods(Access = public)
        ...
        function [railTime, railState] = RailSim(obj)
           ...
           % Initial Conditions
            ...
            % integration
            [railTime,railState] = ode15s(@(t,x) obj.Dynamics_Rail_1DOF(t,x),tspan,initialPosition, Option); 
        ...
        function [flightTime, flightState, T2E, S2E, I2E] = FlightSim(obj, tspan, arg2, arg3, arg4, arg5)
            ...
            % integration
            [flightTime,flightState, T2E, S2E, I2E] = ode15s(@(t,s) obj.Dynamics_6DOF(t,s),tspan,initialState, Option);
        ...
        function [T3, S3, drogueTimeEvents, drogueStateEvents, drogueEventIndices] = DrogueParaSim(obj, initialTime, initialPosition, initialVelocity)
            ...
            % integration
            [T3,S3, drogueTimeEvents, drogueStateEvents, drogueEventIndices] = ode15s(@(t,s) obj.Dynamics_Parachute_3DOF(t,s,obj.Rocket,obj.Environment, M, 0),tspan,initialState, Option);
        ...
        function [mainChuteTime, mainChuteState, mainChuteTimeEvents, S4E, mainChuteEventsIndices] = MainParaSim(obj, initialTime, initialPosition, initialVelocity)
            ...
            % integration
            [mainChuteTime, mainChuteState, mainChuteTimeEvents, S4E, mainChuteEventsIndices] = ode15s(@(t,s) obj.Dynamics_Parachute_3DOF(t,s,obj.Rocket,obj.Environment, M, 1),tspan,initialState, Option);
        ...
        function [crashTime, crashState, crashTimeEvents, crashStateEvents, crashEventIndices] = CrashSim(obj, initialTime, initialPosition, initialVelocity)
            ...
            % integration
            [crashTime,crashState, crashTimeEvents, crashStateEvents, crashEventIndices] = ode15s(@(t,s) obj.Dynamics_3DOF(t,s,obj.Rocket,obj.Environment),tspan,initialState, Option);
