...
% -------------------------------------------------------------------------      
   methods(Access = protected)
        ...
        function S_dot = Dynamics_Rail_1DOF(obj, t, s)
            ...
            % Environment
            g = 9.81;               % Gravity [m/s2] 
            [~, a, p, density, Nu] = stdAtmos(x*sin(obj.Environment.railAngle) + obj.Environment.startAltitude ,obj.Environment); % Atmosphere information (TODO: Include effect of humidity and departure altitude)
        ...
        function S_dot = Dynamics_6DOF(obj, t, s)
            ...
            % Environment
            g = 9.81;               % Gravity [m/s2] 
            [~, a, p, density, nu] = stdAtmos(X(3)+obj.Environment.startAltitude,...
...
%             end
        ...
        function dsdt = Dynamics_Parachute_3DOF(obj, t,s, Rocket, Environment, M, Main)
            ...
            % Atmospheric Data
            [~, ~, p, density] = stdAtmos(X(3)+Environment.startAltitude, Environment); % Atmosphere [K,m/s,Pa,kg/m3]
