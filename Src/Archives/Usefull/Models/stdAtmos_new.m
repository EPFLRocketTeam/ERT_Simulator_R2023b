...
Env.date=20210419;
Env.time=17;
Env.startLatitude=47;
Env.startLongitude=8;
alt=3000;
...
lat_index= Env.startLatitude/0.25 + 90/0.25 + 1;    %lattitude starts as -90° and matlab indexes start at 1 and increments of 0.25
lon_index= round(Env.startLongitude/0.25)+1 ; %lattitude starts as 0° and matlab indexes start at 1
